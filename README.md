...
![](https://img.shields.io/github/languages/top/Name-Terry/VBlog.svg?style=flat)
![](https://img.shields.io/github/stars/Name-Terry/VBlog.svg?style=social)
...
## 快速使用
搭建博客只需2步
- 点击github头像旁边的 "+" 号 选择 ```Import repository ```克隆地址填 ```https://github.com/Name-Terry/Name-Terry.github.io ```项目名填 ```你的用户名.github.io ```
- 克隆完成后 修改文件 ```/static/configuration.json``` 中的 ```githubUsername``` 为自己的github用户名


类似演示地址其中 Name-Terry 为我的用户名


现在 ```https://你的用户名.github.io``` 就是你的个人博客了,例如[https://Name-Terry.github.io][1]
