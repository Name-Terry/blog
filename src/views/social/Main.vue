                    ...
                    <div v-loading="followers.loading">
                        <div v-if="followers.list.length">
                            <el-row style="min-height: 200px; ">
                                <el-col v-for="(item,index) in followers.list" :span="8" :key="'followers'+index" style="padding: 10px">
                                    <el-card shadow="hover" style="font-size: 13px;color: #606266;line-height: 20px">
                                        ...
                                        <a style=" text-decoration:none;cursor:pointer" @click="$router.push(`/user/social/details/${item.name}`)">{{ item.name }}</a>
                                        <br>
                            ...
                            <div style="text-align: center;margin-top: 10px">
                                <el-pagination :current-page.sync="followers.query.page" :page-size="followers.query.pageSize" :total="followers.query.pageNumber*followers.query.pageSize" background
                                               layout="prev, pager, next" @current-change="onSelect"/>
                            </div>
                        </div>
                ...
                <el-tab-pane :label="'关注 '+followingTotal" name="following" style="padding: 5px">
                    <div v-loading="following.loading">
                        <div v-if="following.list.length">
                            ...
                            <div style="text-align: center;margin-top: 10px">
                                <el-pagination :current-page.sync="following.query.page" :page-size="following.query.pageSize" :total="following.query.pageNumber*following.query.pageSize" background
                                               layout="prev, pager, next" @current-change="onSelect"/>
                            </div>
                        </div>
                        <div v-else style="min-height: 300px;margin-bottom: 20px;padding: 20px 0px 20px 0px;text-align: center">
