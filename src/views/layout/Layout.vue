<template>
    <div>
        <section :style="'background-image: linear-gradient(120deg, '+backgroundColorLeft+', '+backgroundColorRight+');color: '+fontColor+';'" class="page-header">
            <div style="position:absolute; top:20px; right:20px; z-index:2;">
                <el-tooltip :content="fullButton.full?'退出':'全屏'" effect="dark" placement="bottom-end">
                    <el-button :icon="fullButton.full?'el-icon-close':'el-icon-rank'" circle @click="full"/>
                </el-tooltip>
            </div>
            ...
            <a v-if="!mini" href="https://github.com/Name-Terry/vblog" class="btn" target="_blank">博客源码</a>
        </section>
        <div style="position:relative;  z-index:2;margin: auto;margin-top:-30px;width:84rem;">
            <el-card :body-style="{ padding: '0px' }" shadow="never">
                <el-row>
                    <el-col :span="10">
                        <el-menu :default-active="topbar.active" style="border: none" mode="horizontal" menu-trigger="hover" @select="selectTopbar">
                            ...
                            <el-submenu v-if="webSites.length>0" index="#webSites">
                                ...
                                <el-menu-item v-for="(item,index) in webSites" :index="'#webSites-'+index" :key="'#webSites'+index">{{ item.name }}</el-menu-item>
                            </el-submenu>
                        </el-menu>
                    </el-col>
                    <el-col :span="8" style="text-align: center;padding: 12px 0px 0px 10px">
                        <el-row>
                            <el-col :span="4">
                                <el-popover placement="top" trigger="hover">
                                    ...
                                    <el-button id="play" slot="reference" :icon="music.isPlay?'el-icon-refresh':'el-icon-caret-right'" circle @click="play"/>
                                </el-popover>
                            </el-col>
                            <el-col :span="14" style="padding-left: 20px">
                                <el-slider :format-tooltip="$util.formatTime" :max="music.maxTime" v-model="music.currentTime" style="width: 100%;" @change="changeTime"/>
                            </el-col>
                        ...
                        <audio v-if="audioAutoPlay" ref="music" loop autoplay>
                    ...
                    <el-col :span="4" style="text-align: right;">
                        ...
                        <div style="color:#606266;">
                            <i class="el-icon-location"/>&nbsp;{{ location?location:'未填写地址' }}
                            <br>
                        </div>
                    </el-col>
                    <el-col :span="2" style="text-align: center;">
                        ...
                        >
                        <el-popover ref="bigAvatar" :title="githubUsername" placement="top-start" width="200" trigger="hover">
                            <i class="el-icon-star-on"/>&emsp;{{ name }}
                            <br>
                            <i class="el-icon-location"/>&emsp;{{ location }}
                            <br>
